...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    //마이페이지 회원 리뷰 조회
    @Query("SELECT r FROM Review r JOIN FETCH r.member JOIN FETCH r.trainer WHERE r.member.memberId = :memberId")
    List<Review> findReviewByMemberMemberId(Long memberId);
}
