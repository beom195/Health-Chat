...
var FullCalendar = function (e) {
    ...
    function E(e, t, n, r, i) {
        ...
        } else if ("o" === t[0] && "n" === t[1]) s = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + s] = n, n ? r || e.addEventListener(t, s ? D : S, s) : e.removeEventListener(t, s ? D : S, s); else if ("dangerouslySetInnerHTML" !== t) {
    ...
    function T(e, t, n, r, i, s, o, a, l, c) {
        ...
        for (n.__k = [], h = 0; h < t.length; h++) if (null != (p = n.__k[h] = null == (p = t[h]) || "boolean" == typeof p ? null : "string" == typeof p || "number" == typeof p || "bigint" == typeof p ? m(null, p, null, null, p) : Array.isArray(p) ? m(y, {children: p}, null, null, null) : p.__b > 0 ? m(p.type, p.props, p.key, p.ref ? p.ref : null, p.__v) : p)) {
            if (p.__ = n, p.__b = n.__b + 1, null === (g = S[h]) || g && p.key == g.key && p.type === g.type) S[h] = void 0; else for (f = 0; f < D; f++) {
    ...
    function N(e, t, r, i, s, o, a, l, c) {
        ...
        try {
            e:if ("function" == typeof _) {
                if (b = t.props, E = (d = _.contextType) && i[d.__c], S = d ? E ? E.props.value : d.__ : i, r.__c ? v = (u = t.__c = r.__c).__ = u.__E : ("prototype" in _ && _.prototype.render ? t.__c = u = new _(b, S) : (t.__c = u = new A(b, S), u.constructor = _, u.render = z), E && E.sub(u), u.props = b, u.state || (u.state = {}), u.context = S, u.__n = i, h = u.__d = !0, u.__h = [], u._sb = []), null == u.__s && (u.__s = u.state), null != _.getDerivedStateFromProps && (u.__s == u.state && (u.__s = f({}, u.__s)), f(u.__s, _.getDerivedStateFromProps(b, u.__s))), g = u.props, p = u.state, u.__v = t, h) null == _.getDerivedStateFromProps && null != u.componentWillMount && u.componentWillMount(), null != u.componentDidMount && u.__h.push(u.componentDidMount); else {
    ...
    function Sr(e, t, n, r, i = Ar(n), s, o) {
        let {refined: a, extra: l} = Dr(e, n, i), c = function (e, t) {
            let n = null;
            e && (n = e.defaultAllDay);
    ...
    function Fr(e, t, n) {
        let {defs: r} = e, i = Dn(e.instances, e => r[e.defId].allDay ? e : Object.assign(Object.assign({}, e), {
            range: {
    ...
    class _s extends Gn {
        ...
        render() {
            ...
            return p(Rs, {unit: "day"}, (e, o) => p("tr", {role: "row"}, i && i("day"), t.map(e => r ? p(As, {
                key: e.toISOString(),
                date: e,
                dateProfile: n,
                todayRange: o,
        ...
        _sliceDateSpan(e, t, n, r, i, ...s) {
            ...
            if (a) {
                let t = function (e, t, n) {
                    let r = Dr({editable: !1}, n), i = wr(r.refined, r.extra, "", e.allDay, !0, n);
                    return {
                        def: i,
                        ui: ci(i, t),
    ...
    class So extends Gn {
        constructor() {
            super(...arguments), this.state = {isPopoverOpen: !1, popoverId: We()}, this.handleLinkEl = e => {
                ...
                let {props: t, context: n} = this, {moreLinkClick: r} = n.options, i = Ao(t).start;
        ...
        render() {
            ...
            return p(Ln.Consumer, null, n => {
                let {viewApi: r, options: i, calendarApi: s} = n, {moreLinkText: o} = i, {moreCnt: a} = e, l = Ao(e),
    ...
    const ca = [Po({
        ...
        eventSourceDefs: [{
            parseMeta: e => "function" == typeof e.events ? e.events : null, fetch(e, t, n) {
                ...
                Ci(e.eventSource.meta.bind(null, Ai(e.range, r)), e => t({rawEvents: e}), n)
            }
        }]
    }), Po({
        ...
        name: "simple-recurring-event", recurringTypes: [{
            parse(e, t) {
                ...
                return r ? function (e, t, n, r) {
                    let i = e ? An(e) : null, s = Mt(n.start), o = n.end, a = [];
                    for (; s < o;) {
                        let e;
        ...
        name: "misc", isLoadingFuncs: [e => qo(e.eventSources)], propSetHandlers: {
            dateProfile: function (e, t) {
                t.emitter.trigger("datesSet", Object.assign(Object.assign({}, Ai(e.activeRange, t.dateEnv)), {view: t.viewApi}))
    ...
    class La {
        ...
        handleMove(e, t) {
            if (this.isEnabled) {
                let n = e - window.scrollX, r = t - window.scrollY,
            ...
            super(e), this.subjectEl = null, this.subjectSeg = null, this.isDragging = !1, this.eventRange = null, this.relevantEvents = null, this.receivingContext = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                ...
                if (e) {
                    ...
                    i === s || t.editable && t.droppable ? (o = function (e, t, n, r) {
                        let i = e.dateSpan, s = t.dateSpan, o = i.range.start, a = s.range.start, l = {};
                        i.allDay !== s.allDay && (l.allDay = s.allDay, l.hasEnd = t.context.options.allDayMaintainDuration, o = s.allDay ? Mt(o) : n);
    ...
    function Ac(e, t, n, r, i) {
        ...
        for (; a.valueOf() < o.valueOf();) {
            const s = n.add(a, Dc), o = {start: e.skipHiddenDays(a), end: e.skipHiddenDays(s, -1, !0)};
    ...
    var _c = Po({
        name: "@fullcalendar/multimonth", initialView: "multiMonthYear", optionRefiners: xc, views: {
            multiMonth: {
                component: class extends ls {
                    constructor() {
                        super(...arguments), this.splitDateProfileByMonth = Gt(Ac), this.buildMonthFormat = Gt(Rc), this.scrollElRef = {current: null}, this.firstMonthElRef = {current: null}, this.needsScrollReset = !1, this.handleSizing = e => {
                            e && this.updateSize()
                        }
                    }
    ...
    }, e.version = "6.1.12", Object.defineProperty(e, "__esModule", {value: !0}), e
}({});